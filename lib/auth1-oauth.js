...
class Auth1Client {
  ...
  async request (url, params) {
    ...
    const authorizationMethod = params.authorizationMethod || this.config.authorizationMethod
    const bodyFormat = params.bodyFormat || 'form'
    const useAuth = typeof (params.useAuth) !== 'undefined' ? !!params.useAuth : true
    const options = {
      url: url,
